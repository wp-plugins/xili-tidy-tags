...
define('XILITIDYTAGS_VER','1.3.3'); /* used in admin UI */
...
class xili_tidy_tags {
	...
	function xili_add_pages() {
 	...
 	function top_tidy_menu_title () { // again with wp3.0 instead '' v1.3.2
 		_e('Message: as super-user you see this page','xili_tidy_tags');
 	}
