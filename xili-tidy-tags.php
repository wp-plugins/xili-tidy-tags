...
define('XILITIDYTAGS_VER','1.5.0'); /* used in admin UI */
...
class xili_tidy_tags_cloud_multiple_widgets extends WP_Widget {
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('tagsgroup'); ?>" ><?php _e('Groups','xili_tidy_tags') ?> : <input id="<?php echo $this->get_field_id('tagsgroup'); ?>" name="<?php echo $this->get_field_name('tagsgroup'); ?>" type="text" value="<?php echo $tagsgroup ?>" /></label><br />
		<label for="<?php echo $this->get_field_id('tagsallgroup'); ?>" ><?php _e('Group #2','xili_tidy_tags') ?> : <input id="<?php echo $this->get_field_id('tagsallgroup'); ?>" name="<?php echo $this->get_field_name('tagsallgroup'); ?>" type="text" value="<?php echo $tagsallgroup ?>" /></label><br />
