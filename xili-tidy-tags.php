...
define('XILITIDYTAGS_VER','1.3.2'); /* used in admin UI */
...
class xili_tidy_tags {
	...
	function init_plugin() { 
		...
		register_taxonomy( TAXOTIDYTAGS, 'term',array('hierarchical' => true, 'label'=>false, 'rewrite' => false, 'update_count_callback' => ''));
		$res = is_term (LANGSTAGSGROUPNAME,TAXOTIDYTAGS);
		if ($res) $this->langgroupid = $res ['term_id'];
