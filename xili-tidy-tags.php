...
# 0.9.0 - 090404 - widget and more actions to create group corresponding to category
...
define('XILITIDYTAGS_VER','0.9.0'); /* used in admin UI */
...
class xili_tidy_tags {
	...
	function  on_sidebox_3_content($data=array()) { 
		...
		foreach ($listterms as $curterm) {
			if ($curterm->parent == 0 && $curterm->term_id != $langgroupid)
...
class xili_tidy_tags_cloud_widget {
	...
	function widget_options() {
		...
		echo '<label for="xili_tdtc_widget_tagsallgroup">'.__('Group #2').': <input id="xili_tdtc_widget_tagsallgroup" name="xili_tdtc_widget_tagsallgroup" type="text" value="'.attribute_escape($options['tagsallgroup']).'" /></label>';
		
		echo '<br /><label for="xili_tdtc_widget_smallest">'.__('Smallest size').': <input id="xili_tdtc_widget_smallest" name="xili_tdtc_widget_smallest" type="text" size="3" value="'.attribute_escape($options['smallest']).'" /></label>';
		echo '<label for="xili_tdtc_widget_largest">'.__('Largest size').': <input id="xili_tdtc_widget_largest" name="xili_tdtc_widget_largest" type="text" size="3" value="'.attribute_escape($options['largest']).'" /></label>';
		echo '<br /><label for="xili_tdtc_widget_number">'.__('Number').': <input id="xili_tdtc_widget_number" name="xili_tdtc_widget_number" type="text" size="3" value="'.attribute_escape($options['number']).'" /></label>';
...
// comment below line if you don't use widget
