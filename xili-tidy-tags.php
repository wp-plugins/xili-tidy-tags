...
# 1.6.4 - 120405 - pre-tests WP3.4: fixes metaboxes columns
...
define('XILITIDYTAGS_VER','1.6.4'); /* used in admin UI */
...
//echo $query ;
	...
	function  on_sidebox_3_content($data=array()) { 
	 	...
	 	if ( !class_exists('xili_language') ) { ?>
	 		...
	 		$res = term_exists (LANGSTAGSGROUPNAME,$this->tidy_taxonomy); //print_r($res); echo (is_array($res)) ? "arr" : '?' ; 
