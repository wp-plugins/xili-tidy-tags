...
* 1.4.0 - full tested 3.0 mono and multisite
* Minor modifications to be compatible with WP 3.0 standalone and wpmu (for testers and future specific improvements for wpmu)
...
== Changelog ==
= 1.3.1, 1.3.2, 1.4.0 = pre-tests for WP3.0-beta, WP3.0-RC1…
