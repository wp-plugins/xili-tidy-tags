...
class xili_tidy_tags_admin extends xili_tidy_tags {
	...
	function admin_init() {
        /* Register our script. */
        wp_register_script( 'datatables-v10', plugins_url('js/jquery.dataTables.min.js', $this->file_file ) , array( 'jquery' ), '1.10.5', true );

        wp_register_style( 'table_style-v10', plugins_url('/css/jquery.dataTables.min.css', $this->file_file ), array(), XILIDICTIONARY_VER, 'screen' );
    }
